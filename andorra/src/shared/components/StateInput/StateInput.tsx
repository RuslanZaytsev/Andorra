...
export const StateInput = ({label, value, onChange, type, placeholder = '', error, disabled}: IInput) => {
    ...
    return (
        <div className={styles.wrapper}>
            ...
            <input disabled={disabled} className={styles.input} type={type} placeholder={placeholder} value={value}
